	...
	public static class Deserializer
	{
        ...
        public static string ImportOrders(FastFoodDbContext context, string xmlString)
        {
            ...
            foreach (var orderDto in deserializedOrders)
            {
                ...
                bool areValidItems = AreValideItems(context, orderDto.OrderItems);
                ...
                sb.AppendLine($"Order for {orderDto.Customer} on " +
                    $"{date.ToString("dd/MM/yyyy HH:mm", CultureInfo.InvariantCulture)} added");
            }
        ...
        private static bool AreValideItems(FastFoodDbContext context, OrderItemDto[] orderItems)
        {
