...
namespace FastFood.DataProcessor
{
	...
	{
		public static string ExportOrdersByEmployee
            (FastFoodDbContext context, string employeeName, string orderType)
		{
		...
		public static string ExportCategoryStatistics
            (FastFoodDbContext context, string categoriesString)
		{
