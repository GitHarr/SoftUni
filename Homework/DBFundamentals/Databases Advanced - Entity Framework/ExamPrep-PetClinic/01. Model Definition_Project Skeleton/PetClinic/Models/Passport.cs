...
namespace PetClinic.Models
{
    ...
    {
        //-	SerialNumber – a string consisting of exactly 10 characters,
        //starting with 7 letters and ending with 3 digits, Primary Key
        //-	Animal – the animal to which the passport is registered(required)
        //-	OwnerPhoneNumber – the phone number of the animal’s owner,
        //required, make sure it matches one of the following requirements:
