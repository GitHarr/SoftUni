namespace p02.CommandInterpreter
{
    ...
    public class Program
    {
        ...
        private static void RollLeftList2(List<string> items, int count)
        {
        ...
        static List<string> ReadInputItems()
        {
            List<string> items = Console.ReadLine().Split(' ')
                .Where(i => i.Length > 0)       // -> върши същото като StringSplitOptions.RemoveEmptyEntries
                .ToList();
            return items;
        }
    }
